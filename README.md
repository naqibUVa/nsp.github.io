...
This is repository for [Mint Lab](http://mint-vu.github.io/). The repository is adopted from [KordingLab](http://kordinglab.com).
We use Jekyll to run our Github page. Feel free to fork and pull-request!
